...
def index():
    ...
    prev_num = url_for('index', posts=posts.prev_num) \
        if posts.has_prev else None
    
    return render_template('index.html',title = 'Home Page', form=form, posts=posts.items, next_url=next_url, prev_num=prev_num)
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Ypur changes have been saved.')
